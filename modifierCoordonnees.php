  ...
  <div id="content"> 
    ...
    <section class="chart-page padding-top-100 padding-bottom-100">
      <div class="container"> 
        ...
        <div class="shopping-cart"> 
          ...
          echo ' <ul class="row">
                  ...
                  <!---Coordonnées-->
                    <li class="col-md-6">
                      <label> *PRENOM
                        <input type="text" name="prenom" value="'.$prenom.'" placeholder="">
                      </label>
                    </li>

                    <li class="col-md-6">
                      <label> *NOM
                        <input type="text" name="nom" value="'.$nom.'" placeholder="">
                      </label>
                    </li>
                    
                    <li class="col-md-6">
                      <label> *TELEPHONE
                        <input type="text" name="tel" value="'.$tel.'" placeholder="12345678">
                      </label>
                    </li>

                    <li class="col-md-6"> 
                      <label>*ADRESSE
                        <input type="text" name="adresse" value="'.$adresse.'" placeholder="">
                      </label>
                    </li>
        ...
        <div class="col-sm-12">
                <h6>MODIFIER DONNEES D'AUTHENTIFICATION</h6>
                <form action="modifierAuth.php" method="POST">
                   <?php 
          ...
          echo ' <ul class="row">
                    ...
                    <li class="col-md-6">
                      <label> *RETAPPEZ MOT DE PASSE
                        <input type="password" name="confirmPass" >
                      </label>
                    </li>

                    <li class="col-md-6">
                      <button type="submit" class="btn" name="register">METTRE A JOUR</button>
                    </li>
                  </ul>';
         }
        mysqli_free_result($afficherProfil);
