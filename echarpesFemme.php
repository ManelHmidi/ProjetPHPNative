        ...
        <div class="container">
          <div class="sidenav col-xs-3 position-static">
            <div class="shop-sidebar"> 
              ...
              <!-- Category -->
            <h5 class="shop-tittle margin-bottom-30">Catégories Pour Femme</h5>
             <ul class="shop-cate">
                <li><a href="giletsFemme.php">Gilets <span></span></a></li>
                <li><a href="robesFemme.php">Robes <span></span></a></li>
                <li><a href="jupesFemme.php">Jupes <span></span></a></li>
                <li><a href="manteauxFemme.php">Manteaux <span></span></a></li>
                <li><a href="chaussuresFemme.php"> Chaussures <span></span></a></li>
                <li><a href="chemisesFemme.php"> Chemises <span></span></a></li>
                <li><a href="pantalonsFemme.php"> Pantalons <span></span></a></li>
                <li><a href="bijouxFemme.php"> Bijoux <span></span></a></li>
                <li><a href="echarpesFemme.php"> Echarpes <span></span></a></li>
              </ul>
          ...
          <div class="heading text-center col-sm-9">
            <h4>Echarpes Pour Femmes</h4>
            <span>Les meilleurs Echarpes au prix le plus bas, Veuillez toujours etre alertes de nos nouveautés.</span>
          </div>
...
$sql = "select * FROM `produit` where categorie ='Echarpe' && sexe= 'Femme'";

if (isset($_POST["liste1"])) {
  if(($_POST["liste1"]) == "1" )
  {
    $sql = "select * FROM `produit` where categorie ='Echarpe' && sexe= 'Femme' order by nomProduit ASC";
  }
  elseif(($_POST['liste1']) == '2' )
  {
    $sql = "select * FROM `produit` where categorie ='Echarpe' && sexe= 'Femme' order by nomProduit DESC";
  }
  elseif(($_POST['liste1']) == '3' )
  {
    $sql = "select * FROM `produit` where categorie ='Echarpe' && sexe= 'Femme' order by prix ASC";   
  }
  elseif(($_POST['liste1']) == '4' )
  {
    $sql = "select * FROM `produit` where categorie ='Echarpe' && sexe= 'Femme' order by prix DESC";
  } elseif(($_POST['liste1']) == '5' )
  {
    $sql = "select * FROM `produit` where categorie ='Echarpe' && sexe= 'Femme' order by dateCreation DESC"; 
  }
}
...
if(($_POST['liste2']) == '2' )
{
  $sql = "select * FROM `produit` where categorie ='Echarpe' && sexe= 'Femme' && prix < 50";
}
