          ...
          <ul>
            ...
            <li data-transition="random" data-slotamount="7" data-masterspeed="300" data-saveperformance="off">
              ...
              <div class="tp-caption sfr font-extra-bold tp-resizeme" data-x="center" data-hoffset="0" data-y="center"
                ...
                data-splitout="none" data-elementdelay="0.07" data-endelementdelay="0.1" data-endspeed="300" style="
                    z-index: 6;
                    font-size: 120px;
                    color: #000;
              ...
              <!-- LAYER NR. 2 -->
              <div class="tp-caption sfr font-extra-bold tp-resizeme" data-x="right" data-hoffset="0" data-y="center"
              ...
              <!-- LAYER NR. 4 -->
                ...
                data-endelementdelay="0.1" data-endspeed="300" data-scrolloffset="0" style="z-index: 8">
      ...
      <section class="padding-top-150 padding-bottom-150">
        <div class="container">
          ...
          <div class="heading text-center">
            ...
            <span>Take a look, you'll find what you need in the lowest prices with garantie</span>
          </div>
...
while ($ind = mysqli_fetch_assoc($resultSQL)) {
  ...
  echo '  <div class="item">
              <!-- Item img -->
              <div class="item-img">
                <img class="img-1" src="'.$row["image"].'" alt="" />
                <!-- Overlay -->
                <div class="overlay">
                  <div class="position-center-center">
                    <div class="inn">
