      ...
      <section class="padding-top-150 padding-bottom-150">
        <div class="container">
          ...
          <div class="heading text-center col-sm-9">
            <h4>Vestes Pour Hommes</h4>
            <span>Les meilleurs Vestes au prix le plus bas, Veuillez toujours etre alertes de nos nouveautés.</span>
          </div>
...
$sql = "select * FROM `produit` where categorie ='Veste' && sexe= 'Homme'";

if (isset($_POST["liste1"])) {
  if(($_POST["liste1"]) == "1" )
  {
    $sql = "select * FROM `produit` where categorie ='Veste' && sexe= 'Homme' order by nomProduit ASC";
  }
  elseif(($_POST['liste1']) == '2' )
  {
    $sql = "select * FROM `produit` where categorie ='Veste' && sexe= 'Homme' order by nomProduit DESC";
  }
  elseif(($_POST['liste1']) == '3' )
  {
    $sql = "select * FROM `produit` where categorie ='Veste' && sexe= 'Homme' order by prix ASC";   
  }
  elseif(($_POST['liste1']) == '4' )
  {
    $sql = "select * FROM `produit` where categorie ='Veste' && sexe= 'Homme' order by prix DESC";
  } elseif(($_POST['liste1']) == '5' )
  {
    $sql = "select * FROM `produit` where categorie ='Veste' && sexe= 'Homme' order by dateCreation DESC"; 
  }
}
...
if(($_POST['liste2']) == '2' )
{
  $sql = "select * FROM `produit` where categorie ='Veste' && sexe= 'Homme' && prix < 50";
}
