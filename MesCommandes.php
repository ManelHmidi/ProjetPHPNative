...
<div class="cart-head">
          ...
          and commande.idCorrespond = (select idCorrespond
          from paniercorrespond
          where idUser ='$idUser')";
          ...
          if ($num == 0) {
            echo "Vous n'avez pas passé aucune commande!";
          }else{

          while ($row = mysqli_fetch_assoc($affiche)) {
            $id=$row["idUser"];
            $req2="select nom, prenom from utilisateur where idUser='$id'";
          ...
          echo '<ul class="row cart-details">
            ...
            <!-- ETAT -->
            <li class="col-sm-1" class="position-center-center">
               <div class="position-center-center"> <span class="price">'.$row["etat"].'</span> </div>
            </li>
