...
$sql = "select * FROM `produit` where categorie ='Gilet' && sexe= 'Enfant'";

if (isset($_POST["liste1"])) {
  if(($_POST["liste1"]) == "1" )
  {
    $sql = "select * FROM `produit` where categorie ='Gilet' && sexe= 'Enfant' order by nomProduit ASC";
  }
  elseif(($_POST['liste1']) == '2' )
  {
    $sql = "select * FROM `produit` where categorie ='Gilet' && sexe= 'Enfant' order by nomProduit DESC";
  }
  elseif(($_POST['liste1']) == '3' )
  {
    $sql = "select * FROM `produit` where categorie ='Gilet' && sexe= 'Enfant' order by prix ASC";   
  }
  elseif(($_POST['liste1']) == '4' )
  {
    $sql = "select * FROM `produit` where categorie ='Gilet' && sexe= 'Enfant' order by prix DESC";
  } elseif(($_POST['liste1']) == '5' )
  {
    $sql = "select * FROM `produit` where categorie ='Gilet' && sexe= 'Enfant' order by dateCreation DESC"; 
  }
}
...
if(($_POST['liste2']) == '2' )
{
  $sql = "select * FROM `produit` where categorie ='Gilet' && sexe= 'Enfant' && prix < 50";
}
