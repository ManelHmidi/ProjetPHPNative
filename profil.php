      ...
      <div class="container">
        <div class="row">
          <div class="col-md-9"> 
            ...
            <article> 
              <!-- Tittle -->
              <div class="post-tittle left"> <h3 class="tittle">
        ...
        ?>
          ...
          <div class="col-md-3">  
            <div class="shop-sidebar"> 
              ...
              <!-- Category -->
              <h5 class="shop-tittle margin-bottom-30">Mon Espace Personnel</h5>
              <ul class="shop-cate">
                  <?php
                  
                  echo '
                  <li><a href="modifierCoordonnees.php?idUser='.$idUser.'">Modifier Coordonnées</a></li>
                  <li><a href="ajoutProduit.php?idUser='.$idUser.'">Ajouter Article</a></li>
                  <li><a href="MesCommandes.php">Voir Mes Commandes</a></li>
                  <li><a href="Reponses.php">Réponses au demandes</a></li>';
                  ?> 
              </ul>
          ...
          echo '<ul class="row cart-details">
            <li class="col-sm-6">
              <div class="media"> 
                ...
                <img class="media-object" src="'.$row["image"].'" alt="" style="height: 100px; width:100px;"> </a></div>
            ...
            <li class="col-sm-2" class="position-center-center">
              <div class="position-center-center"> <span class="price">'.$row["libelle"].'</span> </div>
            </li>
            
            <!-- PRICE -->
            <li class="col-sm-1" class="position-center-center">
              <div class="position-center-center"> <span class="price">'.$row["prix"].'<small>DT</small></span> </div>
            </li>

            <!-- REMOVE -->
            <li class="col-sm-1" class="position-center-center">
              <div class="position-center-center"> <a href="remove.php?idProduit='.$row["idProduit"].'"><i class="icon-close"></i></a> </div>
            </li>

            <!-- MODIFIER -->
            <li class="col-sm-1" class="position-center-center">
              <div class="position-center-center"> <a href="modifierProduit.php?idProduit='.$row["idProduit"].'"><input type="submit" value="Modifier" /></a> </div>
            </li>
          </ul>';
        }
