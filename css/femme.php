               ...
               <li class="dropdown">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a href="bigouxFemme.php">bigoux</a></li>
        ...
        <div class="container">
          <div class="sidenav col-xs-3 position-static">
            <div class="shop-sidebar"> 
              ...
              <!-- Category -->
              <h5 class="shop-tittle margin-bottom-30">Catégories Pour Femmes</h5>
              <ul class="shop-cate">
                    <li><a href="giletsFemme.php">Gilets</a></li>
                    <li><a href="robesFemme.php">Robes</a></li>
                    <li><a href="jupesFemme.php">Jupes</a></li>
...
if(($_POST['liste2']) == '1' )
{
    $sql = "select * FROM `produit` where sexe= 'Femme' && month(dateCreation) = (month(date())-1) ";
}
